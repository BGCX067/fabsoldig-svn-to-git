	...
	<div class="row">
		...
		<!-- Teléfono de Contacto -->
			...
			<div id="formTelefono" class="col-sm-3 form-group col-sm-3">
				...
				<input type="text" id="txtTelefono" name="txtTelefono" value="" placeholder="Número de Contacto" 
		...
		<!-- Correo Electrónico -->
			<div class="form-group col-sm-3">
				<!--  label  class="form-control form-control3" type="text" id="txtTitCorreo" name="txtTitCorreo" value="Correo Electrónico" disabled="disabled"/-->
				<label class = "form-control form-control3">Correo Electrónico</label>
	...
	<div class="row">
		...
		<div class="form-group col-sm-12">
	    	<div id="checkbox" class="col-sm-12" align="center">
	        	...
	        	<label id="laut" style="color: #333333;"><ins  style="cursor: pointer">He leído y autorizo el Tratamiento de Datos Personales</ins></label>
	    	</div>
